...
export const Whatsapp = {
  ...
  export const voicecall = {
    title: "Bulk Voice Call - Frequently Asked Questions",
    faqs: [
      {
        id: 1,
  ...
  export const RcsData = {
    title: "RCS Messaging - Frequently Asked Questions",
    faqs: [
      {
        id: 1,
  ...
  export const bulkSmsData = {
    title: "Bulk SMS - Frequently Asked Questions",
    faqs: [
      {
        id: 1,
  ...
  export const whatsappFaqData = {
    title: "Discover WhatsApp Business Solutions - FAQs",
    faqs: [
      {
        id: 1,
        question: "Why is WhatsApp the ultimate communication tool for businesses?",
        answer:
          "With over 2 billion active users, WhatsApp offers businesses a direct and personal way to connect with customers. Whether it's promotions, support, or updates, it ensures faster communication, stronger relationships, and higher engagement.",
        icon: "bi-graph-up-arrow",
      },
      {
        id: 2,
        question: "How can I send personalized promotions through WhatsApp?",
        answer:
          "Our platform allows you to send bulk WhatsApp messages while including customer names and other details for a personal touch. Reach your audience with tailored promotions, exclusive deals, and updates that drive results.",
        icon: "bi-gift",
      },
      {
        id: 3,
        question: "Is WhatsApp safe for sharing important business information?",
        answer:
          "Absolutely! WhatsApp uses end-to-end encryption, ensuring that messages, files, and sensitive details are secure. Businesses can confidently share updates, OTPs, and notifications without worrying about data breaches.",
        icon: "bi-lock-fill",
      },
      {
        id: 4,
        question: "Can I use WhatsApp to provide instant customer support?",
        answer:
          "Yes! WhatsApp makes it easy to offer real-time, two-way support. Respond to customer queries, share order updates, and resolve issues instantly, enhancing satisfaction and trust in your brand.",
        icon: "bi-chat-dots-fill",
      },
      {
        id: 5,
        question: "How do I get started with WhatsApp Business at a2zsms.in?",
        answer:
          "It’s quick and easy! Sign up on our website, select WhatsApp Business services, and start creating impactful campaigns. Our experts will guide you every step of the way to maximize your reach and engagement.",
        icon: "bi-rocket-takeoff",
      },
    ],
  };
  
  // Add other FAQ datasets as needed

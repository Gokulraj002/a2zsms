...
import Bulksms from "../../image/feature-icon/hero-girl.png";
import icon1 from "../../image/feature-icon/icon-5.png";
import icon2 from "../../image/feature-icon/icon-6.png";
import icon3 from "../../image/feature-icon/icon-7.png";

...
import Blog1 from "./Component/Resources/Blogs/January/Blog1";
import Blog2 from "./Component/Resources/Blogs/January/Blog2";
import Blog3 from "./Component/Resources/Blogs/January/Blog3";
...
import Blog7 from "./Component/Resources/Blogs/January/Blog7";
import Blog8 from "./Component/Resources/Blogs/January/Blog8";
import Blog9 from "./Component/Resources/Blogs/January/Blog9";
import Blog10 from "./Component/Resources/Blogs/January/Blog10";
    ...
    <ScrollToTop/>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="/blogs/top-5-chatbot-platforms-for-whatsApp-business-aPI-developers/" element={<Blog1/>} />
          <Route path="/blogs/how-whatsApp-chatbots-drive-lead-generation-for-indian-startups/" element={<Blog2/>} />
          <Route path="/blogs/building-scalable-customer-support-with-whatsApp-aPI-and-chatbots-in-bangalore/" element={<Blog3/>} />
          ...
          <Route path="/blogs/best-bulk-sMS-provider-in-bangalore-for-businesses/" element={<Blog7/>} />
          <Route path="/blogs/reliable-voice-call-solutions-for-seamless-communication/" element={<Blog8/>} />
          <Route path="/blogs/scalable-oTP-services-for-secure-customer-verification-a2Z-sMS/" element={<Blog9/>} />
          <Route path="/blogs/a2Z-sMS-voice-calls-elevating-your-marketing-strategy/" element={<Blog10/>} />
